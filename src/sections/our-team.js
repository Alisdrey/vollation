...
import avatar1 from 'assets/images/product/shirt1.png';
import avatar2 from 'assets/images/product/shirt4.jpeg';
import avatar3 from 'assets/images/product/shirt3.jpeg';
import avatar4 from 'assets/images/product/shirt4.jpeg';
...
const data = [
  {
    id: 1,
    avatar: avatar1,
    name: 'Camiseta Calma Carai',
    designation: '100% Algodão',
    socialLinks: [
      {
        name: 'twitter',
    ...
    <Box as="section" id="team" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          ...
          description="Abaixo apresentamos nosso catálogo de produtos! Nele temos todas as opções de personalização de camisetas.
          Conte sempre também com nosso time de atendimento para tirar qualquer dúvida sobre nossos produtos, técnicas e serviços."
        />
      </Container>
      <Box
        sx={{
